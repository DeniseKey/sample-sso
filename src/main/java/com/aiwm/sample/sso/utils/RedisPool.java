package com.aiwm.sample.sso.utils;
...
public class RedisPool {
    ...
    private static String redisPwd=PropertiesUtil.getProperty("redisl.password");
    ...
    private static void initPool(){
        ...
        pool = new JedisPool(config,redisIp,redisPort,1000*2,redisPwd);
    }
